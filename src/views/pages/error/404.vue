...
<template>
  <div class="container-404 container-star">
    <div v-for="i in 30" :key="i" class="star-1"></div>
    <div v-for="i in 30" :key="i" class="star-2"></div>
  </div>
  <div class="container-404 container-bird">
    ...
    <div class="container-title">
      ...
      <div class="subtitle">啊哦。页面找不到了~</div>
      <div class="btn">
        <button @click="backView" style="margin-left:20px">返回上一页</button>
      </div>
    </div>
  </div>
</template>
